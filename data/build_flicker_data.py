...
tf.flags.DEFINE_string("train_image_dir", "/home/ubuntu/data/images",
                       "Training image directory.")
tf.flags.DEFINE_string("val_image_dir", "/home/ubuntu/data/images",
                       "Validation image directory.")
tf.flags.DEFINE_string("test_image_dir", "/home/ubuntu/data/images",
                       "test image directory.")
tf.flags.DEFINE_string("captions_file", "/home/ubuntu/data/Flickr8k.token.txt",
...
tf.flags.DEFINE_string("output_dir", "/home/ubuntu/data/tfrecord", "Output data directory.")

tf.flags.DEFINE_integer("train_shards", 8,"Number of shards in training TFRecord files.")
...
tf.flags.DEFINE_string("word_counts_output_file", "/home/ubuntu/data/word_counts.txt",
                       "Output vocabulary file of word counts.")

tf.flags.DEFINE_integer("num_threads", 4,
                        "Number of threads to preprocess the images.")
tf.flags.DEFINE_string("train_images_file","/home/ubuntu/data/Flickr_8k.trainImages.txt",
						"train set images file")
tf.flags.DEFINE_string("val_images_file","/home/ubuntu/data/Flickr_8k.devImages.txt",
						"val set images file")
tf.flags.DEFINE_string("test_images_file","/home/ubuntu/data/Flickr_8k.testImages.txt",
...
def _bytes_feature_list(values):
  ...
  return tf.train.FeatureList(feature=[_str2bytes_feature(v) for v in values])
...
def _to_sequence_example(image, decoder, vocab):
  ...
  try:
    dencoded_image = decoder.decode_jpeg(encoded_image)
  ...
  context = tf.train.Features(feature={
      ...
      "image/data": _bytes_feature(tf.compat.as_bytes(encoded_image))
  })
...
def _load_and_process_metadata(Images_f,captions_file, image_dir):
  ...
  with tf.gfile.FastGFile(Images_f, "r") as f:
    img_list = [i[0:-1] for i in f.readlines()]
  with tf.gfile.FastGFile(captions_file, "r") as f:
    l = f.readline()
    print(l.split('#'))
    print(l.split('#')[1][2:-1])
    ...
    for l in f.readlines():
        ...
        if img in img_list:
            ...
            if img!=img_now:
                ...
                id_to_filename.append((img_id,img))
                img_now = img
            else:
                id_to_captions[img_id].append(caption)
  #以上区块获取到：id_to_captions与id_to_filename，
...
def main(unused_argv):
  ...
  mscoco_train_dataset = _load_and_process_metadata(FLAGS.train_images_file,FLAGS.captions_file,
                                                    FLAGS.train_image_dir)
  mscoco_val_dataset = _load_and_process_metadata(FLAGS.val_images_file,FLAGS.captions_file,
                                                  FLAGS.val_image_dir)
  mscoco_test_dataset = _load_and_process_metadata(FLAGS.test_images_file,FLAGS.captions_file,
...
#我们要用完整数据集，数据集不大
  ...
  test_dataset = mscoco_test_dataset

  # Create vocabulary from the training captions.
  train_captions = [c for image in mscoco_train_dataset for c in image.captions]
